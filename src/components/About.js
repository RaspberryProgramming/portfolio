    ...
    return (
      <div className="About">
        ...
        <Card
          ...
          AFA run Cyber Patriot competition, and the Skills USA compeition. 
        </Card>
        ...
        <Card
          ...
          Taking classes at OCCC helped shape my career. While at OCCC, I took classes where I learned C++, Java, Datastructors, Assembly and more. I also took part in the
          Computer Science Club, Outdoors Club, and various other activities.
        </Card>
        ...
        <Card
          ...
          skills={["C#", "ASP.NET MVC", "Entity Framework", "MSSQL", "Microsoft Message Queuing", "Angular", "Typescript", "Oracle SQL", "Various Credit Payment API's"]}>
            ...
            management software, as well as their payment software. In addition, I work on older systems for support. This has exposed me to all sorts of current
            and legacy designs of software. Throughout my time at TRMI, Inc. I have been able to learn a lot as well as make learn how to bring new employees up
            to speed so they can also work on the software.
        </Card>
